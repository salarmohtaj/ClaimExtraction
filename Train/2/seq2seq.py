...
# source field
SRC = Field(tokenize = tokenize_en,init_token = '<sos>',eos_token = '<eos>',fix_length= 100,lower = True)
# target field
TRG = Field(tokenize = tokenize_en,init_token = '<sos>',eos_token = '<eos>',fix_length= 20,lower = True)
